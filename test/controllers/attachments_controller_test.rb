...
class AttachmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attachment" do
    assert_difference('Attachment.count') do
      post attachments_url, params: { attachment: { string: @attachment.string, type: @attachment.type, url: @attachment.url } }
    end
  ...
  test "should update attachment" do
    patch attachment_url(@attachment), params: { attachment: { string: @attachment.string, type: @attachment.type, url: @attachment.url } }
